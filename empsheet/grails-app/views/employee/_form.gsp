...
<div class="fieldcontain ${hasErrors(bean: employeeInstance, field: 'localAddress.city', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: employeeInstance, field: 'personalAddress.city', 'error')} ">
